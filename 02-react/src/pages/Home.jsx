...
export function HomePage() {
    ...
    const handleSearchSubmit = (event) => {
        ...
        const url = "/employment?search=" + encodeURIComponent(searchQuery);
    ...
    return (
        <main>
            ...
            <form role="search" onSubmit={handleSearchSubmit}>
                ...
                <input required type="text" placeholder="Buscar empleos por título, habilidad o empresa" name="search" />
